...
fn main() {
    ...
    let input: Input = Input::from("N:/Anime/[AniPlague] Food Court de Mata Ashita S01 1080p/[AniPlague] Food Court de Mata Ashita - 01.mkv").set_readrate(1.0); // Optional: limit reading speed
    ...
    let input: Input = Input::from("../../test.mp4").set_readrate(1.0); // Optional: limit reading speed
